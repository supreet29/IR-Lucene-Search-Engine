...
public class parser {
	public static void main(String[] args) throws IOException {
	    	...
	    	File[] file = new File("/Users/supreetsingh/Desktop/IR_Assignement2/Assignment_Two/latimes").listFiles();
    		...
    		//	System.out.println("Directory: " + file.length);
	    	    ...
	    	    for (Element e: docs) {
	    				...
	    				System.out.println("Type" + ":   " + Type);
	    				 ...
	    				 File result = new File("/Users/supreetsingh/Desktop/IR_Assignement2/latimes_docs/"+DocNo);
